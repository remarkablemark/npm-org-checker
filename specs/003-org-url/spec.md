...
1. **Given** a user enters a valid organization name, **When** the availability check completes, **Then** the system displays "See user/organization: <url>"
2. **Given** a user enters an organization name that conflicts with existing users or scopes, **When** the check shows "unavailable", **Then** the system displays "See user/organization: <url>"
...
- **FR-005**: System MUST display the organization URL as a clickable link that opens in a new tab with the text "See user/organization:"

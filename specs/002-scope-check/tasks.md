...
- [x] T001 Verify Vitest testing framework with @testing-library/react configuration ✅ ALREADY DONE
- [x] T002 [P] Review existing npmRegistry.ts structure and patterns
- [x] T003 [P] Verify existing validation utilities in src/utils/validation.ts
- [x] T004 [P] Review existing useAvailabilityChecker hook implementation
- [x] T005 [P] Verify existing OrgNameChecker component structure
- [x] T006 [P] Verify validateOrganizationName function exists in src/utils/validation.ts
- [x] T007 [P] Document validateOrganizationName validation rules in src/utils/validation.ts
- [x] T008 [P] Test validateOrganizationName with scope names in src/utils/validation.test.ts
- [x] T009 Review existing error handling patterns and timeout configuration
...
- [x] T010 [P] [US1] Test unified validation with valid organization names in src/utils/validation.test.ts
- [x] T011 [P] [US1] Test unified validation with valid scope names in src/utils/validation.test.ts
- [x] T012 [P] [US1] Test unified validation with invalid formats in src/utils/validation.test.ts
- [x] T013 [P] [US1] Test validation edge cases (length, special characters) in src/utils/validation.test.ts
...
- [x] T014 [US1] Verify existing validateOrganizationName function handles all name types in src/utils/validation.ts
- [x] T015 [US1] Confirm unified validation applies to all input types in src/utils/validation.ts
- [x] T016 [US1] Remove any format detection logic from validation flow in src/utils/validation.ts
- [x] T017 [US1] Update validation documentation to reflect unified approach in src/utils/validation.ts
- [x] T018 [US1] Add validation type definitions for unified name checking in src/types/index.ts
- [x] T019 [US1] Update validation error messages to be name-type agnostic in src/utils/validation.ts
...
- [x] T020 [P] [US2] Test checkScopeExists function with existing scope in src/utils/npmRegistry.test.ts
- [x] T021 [P] [US2] Test checkScopeExists function with available scope in src/utils/npmRegistry.test.ts
- [x] T022 [P] [US2] Test checkScopeExists function with network errors in src/utils/npmRegistry.test.ts
- [x] T023 [P] [US2] Test checkScopeExists function with timeout errors in src/utils/npmRegistry.test.ts
- [x] T024 [P] [US2] Test enhanced checkNameAvailability with user conflict in src/utils/npmRegistry.test.ts
- [x] T025 [P] [US2] Test enhanced checkNameAvailability with scope conflict in src/utils/npmRegistry.test.ts
- [x] T026 [P] [US2] Test enhanced checkNameAvailability with organization conflict in src/utils/npmRegistry.test.ts
- [x] T027 [P] [US2] Test enhanced checkNameAvailability with no conflicts in src/utils/npmRegistry.test.ts
...
- [x] T028 [P] [US2] Add ScopeCheckResponse interface in src/utils/npmRegistry.ts
- [x] T029 [US2] Implement checkScopeExists function in src/utils/npmRegistry.ts
- [x] T030 [US2] Add npm replicate endpoint URL construction logic in src/utils/npmRegistry.ts
- [x] T031 [US2] Add corsmirror proxy integration for scope checking in src/utils/npmRegistry.ts
- [x] T032 [US2] Implement scope existence parsing (rows.length > 0) in src/utils/npmRegistry.ts
- [x] T033 [US2] Add comprehensive error handling for scope checking in src/utils/npmRegistry.ts
- [x] T034 [US2] Enhance checkNameAvailability function with scope checking step in src/utils/npmRegistry.ts
- [x] T035 [US2] Add timeout handling for scope checking API calls in src/utils/npmRegistry.ts
- [x] T036 [US2] Update error handling to include scope-specific context in src/utils/npmRegistry.ts
...
- [x] T037 [P] [US3] Test real-time validation feedback for organization names in src/hooks/useAvailabilityChecker.test.ts
- [x] T038 [P] [US3] Test real-time validation feedback for scope names in src/hooks/useAvailabilityChecker.test.ts
- [x] T039 [P] [US3] Test validation feedback clearing on input correction in src/hooks/useAvailabilityChecker.test.ts
- [x] T040 [P] [US3] Test debouncing behavior with enhanced validation in src/hooks/useAvailabilityChecker.test.ts
...
- [x] T041 [US3] Verify useAvailabilityChecker hook works with enhanced validation in src/hooks/useAvailabilityChecker.ts
- [x] T042 [US3] Test real-time validation feedback for all name types in src/hooks/useAvailabilityChecker.ts
- [x] T043 [US3] Verify 300ms debounce works with scope checking in src/hooks/useAvailabilityChecker.ts
- [x] T044 [US3] Update error message handling for scope conflicts in src/hooks/useAvailabilityChecker.ts
...
- [x] T045 [P] Test scope names with special characters (#, $) in src/utils/validation.test.ts
